    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Patients", x => x.OIB);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PatientOIB = table.Column<string>(type: "text", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Checkups_Patients_PatientOIB",
                        column: x => x.PatientOIB,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MedicalHistories_Patients_PatientOIB",
                        column: x => x.PatientOIB,
                        principalTable: "Patients",
                        principalColumn: "OIB",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Prescriptions_Patients_PatientOIB",
                        column: x => x.PatientOIB,
                        principalTable: "Patients",
                        principalColumn: "OIB",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MedicalHistories_PatientOIB",
                table: "MedicalHistories",
                column: "PatientOIB");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Prescriptions_PatientOIB",
                table: "Prescriptions",
                column: "PatientOIB");
        }
